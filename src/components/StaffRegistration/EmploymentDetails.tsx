                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)}>
                        <div className="grid grid-cols-3 gap-x-8 gap-y-3">
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel htmlFor="employment_type" className="pl-1 text-blue-500 font-semibold">
                                            Employment Type
                                        </FormLabel>
                                        <FormControl>
                                            <Input
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel htmlFor="designation" className="pl-1 text-blue-500 font-semibold">
                                            Designation
                                        </FormLabel>
                                        <FormControl>
                                            <Select
                                            ...
                                            >
                                                <SelectTrigger
                                                    id='designation'
                                                    className={`border border-gray-300 px-3 py-6 rounded-md text-md tracking-wider focus:to-blue-500 focus:border-blue-500 ${field.value ? "text-gray-700" : "text-gray-400"}`}
                                                >
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel htmlFor="department" className="pl-1 text-blue-500 font-semibold">
                                            Department
                                        </FormLabel>
                                        <FormControl>
                                            <Select
...
<FormField
              ...
              />
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel htmlFor="experience_years" className="pl-1 text-blue-500 font-semibold">
                                            Experience (Years)
                                        </FormLabel>
                                        <FormControl>
                                            <Input
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel htmlFor="highest_qualification" className="pl-1 text-blue-500 font-semibold">
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel htmlFor="uan" className="pl-1 text-blue-500 font-semibold">
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel htmlFor="pf_account_number" className="pl-1 text-blue-500 font-semibold">
                                            PF Account Number
                                        </FormLabel>
                                        <FormControl>
                                            <Input
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel htmlFor="esi_code_number" className="pl-1 text-blue-500 font-semibold">
                                            ESI Code Number
                                        </FormLabel>
                                        <FormControl>
                                            <Input
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel htmlFor="reporting_manager" className="pl-1 text-blue-500 font-semibold">
                                            Reporting Manager
                                        </FormLabel>
                                        <FormControl>
                                            <Select
