...
import { Mail, Lock, Eye, EyeOff, CircleX, Phone, Loader } from "lucide-react";
import {
  Form,
  FormControl,
  FormField,
...
const Login: React.FC<LoginProps> = ({
  ...
  const [isSubmitting, setIsSubmitting] = useState(false); // Using existing state for both OTP and password submission
