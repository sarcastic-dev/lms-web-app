...
const Login: React.FC<LoginProps> = ({
  ...
  const handleForgotPasswordClick = () => {
    ...
    setFormData({
      email: emailOrPhoneNumber,
      phone: "", // Default to empty string if not used
    });
  };
            ...
            >
              <div>
                      ...
                      <FormControl>
                        <div className="relative space-y-2">
                          <Input
                            ...
                            type="text"
                            className={`sm:w-[250px] md:w-[320px] lg:w-[402px] mb-4 ${
                ...
                <Button
                  variant={"lmsActive"}
                  type="submit"
                  className={`sm:w-[250px] md:w-[320px] lg:w-[402px] mb-8 ${showPasswordInput && "mt-5"}`}
                >
