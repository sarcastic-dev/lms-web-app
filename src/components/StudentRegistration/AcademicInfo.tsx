...
const AcademicInfoForm = ({
  ...
  const form = useForm<AcademicInfoSchemaType>({
    ...
    defaultValues: {
      registrationNumber: basicInfo?.student?.registrationNumber || "",
      serialNumber: basicInfo?.student?.serialNumber || "",
          ...
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <div className="grid grid-cols-3 gap-x-8 gap-y-3 text-sm">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel htmlFor="serialNumber" className="pl-1">
                      Serial Number
                    </FormLabel>
                    <FormControl>
                      <Input
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel htmlFor="programClass" className="pl-1">
                      Program/Class
                    </FormLabel>
                    <FormControl>
                      <Input
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel htmlFor="section" className="pl-1 ">
                      Section
                    </FormLabel>
                    <FormControl>
                      <Input
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel htmlFor="classRollNumber" className="pl-1 ">
                      Class Roll Number
                    </FormLabel>
                    <FormControl>
                      <Input
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="">
                    <FormLabel htmlFor="admissionDate" className="pl-1">
                      Date Of Admission
                    </FormLabel>
                    <FormControl>
                      <Input
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel htmlFor="boardUniversity" className="pl-1 ">
                      Board/University
                    </FormLabel>
                    <FormControl>
                      <Input
