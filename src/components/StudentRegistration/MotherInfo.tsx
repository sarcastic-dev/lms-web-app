...
const MotherInfo = ({ onNext }: { onNext: (data: any) => void }) => {
    ...
    const form = useForm<MotherInfoSchemaType>({
        resolver: zodResolver(motherInfoSchema),
        defaultValues: {
            name: "",
            mobileNumber: "",
            emailID: "",
    ...
    const onSubmit = (values: MotherInfoSchemaType) => {
        onNext(values);
    };
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)}>
                        <div className="grid grid-cols-3 gap-x-8 gap-y-3">
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel htmlFor="mother_email" className="pl-1 text-blue-500 font-semibold">
                                            Mother Email ID
                                        </FormLabel>
                                        <FormControl>
                                            <Input
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel htmlFor="educational_qualification" className="pl-1 text-blue-500 font-semibold">
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel htmlFor="occupation" className="pl-1 text-blue-500 font-semibold">
                                            Occupation
                                        </FormLabel>
                                        <FormControl>
                                            <Input
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel htmlFor="work_organization_name" className="pl-1 text-blue-500 font-semibold">
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel htmlFor="annual_income" className="pl-1 text-blue-500 font-semibold">
                                            Annual Income
                                        </FormLabel>
                                        <FormControl>
                                            <Input
