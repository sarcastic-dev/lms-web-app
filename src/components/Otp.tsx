    ...
    <div className="bg-white p-8 rounded sm:w-[320px] md:w-[380px] lg:w-[466px] h-3/6 z-10">
      ...
      <div className="flex flex-col items-center">
        <div className="flex space-x-4 mb-3 sm:mr-[35px] md:mr-[48px] lg:mr-[80px]">
          {otp.map((digit, index) => (
            <input
              ...
              id={`otp-input-${index}`}
              type="text"
              className="sm:w-6 sm:h-[6] md:w-8 md:h-8 lg:w-10 lg:h-10 text-center text-lg border focus:border-2 focus:border-[#115DB8] outline-none rounded"
              value={digit}
        ...
        <Button
          variant={"lmsActive"}
          type="submit"
          className="sm:w-[255px] md:w-[320px] lg:w-[402px] text-white text-sm font-semibold py-[10px] rounded"
