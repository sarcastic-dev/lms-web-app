...
const staffRegistrationSlice = createSlice({
  ...
  reducers: {
    ...
    setBasicInfoUserDetailData: (state, action: PayloadAction<BasicInfoEmployee["user"]>) => {
      state.basicInfo.user = action.payload;
    },
    setBasicInfoStaffData: (state, action: PayloadAction<BasicInfoEmployee["staff"]>) => {
      state.basicInfo.staff = action.payload;
    },
    setAddressInfoData: (state, action: PayloadAction<AddressStaffInfo>) => {
      state.addressInfo = action.payload;
    },
    setAdditionalDetailsData: (state, action: PayloadAction<AdditionalDetails>) => {
      state.additionalInfo = action.payload;
    },
    setPreviousExperienceData: (state, action: PayloadAction<PreviousExperience>) => {
